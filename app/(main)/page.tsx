            ...
            <div className="col-12 xl:col-6">
                <div className="card">
                    ...
                    <DataTable value={products} rows={5} paginator responsiveLayout="scroll">
                        ...
                        <Column header="File" body={(data) => <i className="pi pi-file" style={{ fontSize: '1.5rem' }}/> }/>                        
            ...
            <div className="col-12 xl:col-6">
                ...
                >
                    <div>
                        ...
                        <div className="text-white font-medium text-5xl">Try KADAL AI</div>
                    </div>
