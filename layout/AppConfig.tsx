...
const AppConfig = (props: AppConfigProps) => {
    ...
    // const storedLayoutConfig = JSON.parse(localStorage.getItem('layoutConfig') || useContext(LayoutContext));
    // const storedLayoutState = JSON.parse(localStorage.getItem('layoutState') || useContext(LayoutContext));
    
    // const [layoutConfig, setLayoutConfig] = useState(storedLayoutConfig || {});
    // const [layoutState, setLayoutState] = useState(storedLayoutState || {});
    // useEffect(() => {
